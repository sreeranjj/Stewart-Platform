...
Rb = 0.20; % Base radius [m] %0.07
Rp = 0.15; % Platform radius [m] %0.04
a = 0.05; % servo operating arm [m] %0.03
s = 0.2566; % servo operating leg [m] %0.25
